...
export const idPackManagersAction = "elem_" + generateId(15);
export const idPackContractsAction = "elem_" + generateId(15);
export const idPackOtherItemsAction = "elem_" + generateId(15);
...
export const idGetUnassignedPlayers = "elem_" + generateId(15);
